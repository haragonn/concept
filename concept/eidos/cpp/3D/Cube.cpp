...
void Cube::DrawDividedTextureCube(Camera* pCamera, const Texture & tex, int uNum, int vNum, int blend)
{
	...
	VertexData3D vertexList[]{
	{ { -0.5f,  0.5f, -0.5f }, {  0.0f,  0.0f, -1.0f }, { u1, v1 } },
	{ {  0.5f,  0.5f, -0.5f }, {  0.0f,  0.0f, -1.0f }, { u2, v1 } },
	{ { -0.5f, -0.5f, -0.5f }, {  0.0f,  0.0f, -1.0f }, { u1, v2 } },
	{ {  0.5f, -0.5f, -0.5f }, {  0.0f,  0.0f, -1.0f }, { u2, v2 } },
	...
	{ { -0.5f,  0.5f,  0.5f }, { -1.0f,  0.0f,  0.0f }, { u1, v1 } },
	{ { -0.5f,  0.5f, -0.5f }, { -1.0f,  0.0f,  0.0f }, { u2, v1 } },
	{ { -0.5f, -0.5f,  0.5f }, { -1.0f,  0.0f,  0.0f }, { u1, v2 } },
	{ { -0.5f, -0.5f, -0.5f }, { -1.0f,  0.0f,  0.0f }, { u2, v2 } },
	...
	{ { -0.5f,  0.5f,  0.5f }, {  0.0f,  1.0f,  0.0f }, { u1, v1 } },
	{ {  0.5f,  0.5f,  0.5f }, {  0.0f,  1.0f,  0.0f }, { u2, v1 } },
	{ { -0.5f,  0.5f, -0.5f }, {  0.0f,  1.0f,  0.0f }, { u1, v2 } },
	{ {  0.5f,  0.5f, -0.5f }, {  0.0f,  1.0f,  0.0f }, { u2, v2 } },
